...
def initialize_parameters(layer_dims,act):
    ...
    if L==2:
        print("It uses logistic regression with",act,"activation function")
    elif L>2:
        print("It is a",L-1,"layer neural network with",L-2,"hidden layers with",act,"activation function")
    else:
